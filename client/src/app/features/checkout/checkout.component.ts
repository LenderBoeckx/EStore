...
export class CheckoutComponent implements OnInit, OnDestroy {
  ...
  //stripe service opdracht geven om na te gaan of de betalen voldaan is
    ...
    try {
      if(this.confirmationToken){
        ...
        if(result.error){
          ...
          //als de betaling voldaan is, winkelwagentje verwijderen en geselecteerde leveringsmethode op null zetten + gebruiker navigeren naar succes component
